...
export default function StaffForm({ initial = {}, onCancel, onSubmit, serverErrors = null, generalMessage = null }){
  ...
  function validate(){
    ...
    if (!designation.trim()) e.designation = 'Designation required'
  ...
  function handleSubmit(e){
    e.preventDefault()
    if (!validate()) return
    onSubmit({ name, designation, phone, email })
  }
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="mb-2">
        ...
        <input value={designation} onChange={e=>setDesignation(e.target.value)} className="w-full border rounded px-2 py-1" />
